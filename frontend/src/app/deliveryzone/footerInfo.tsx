...
export function Map() {
  return (
    <div className="container sm:block mx-auto flex flex-col items-center gap-5 w-[1200px]">
      ...
      <div className="md:block lg:flex block mb-[50px] gap-5 m-10">
        <div className="w-[588px] h-[388px] mb-[50px] bg-white drop-shadow-lg rounded-lg text-black flex justify-center items-center pb-5">
          <div className="h-5/6 w-11/12 lg:block flex flex-col">
            {/* firsthalf */}
