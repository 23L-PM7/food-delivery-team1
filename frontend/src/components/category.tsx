    ...
    <div className="max-w-[1200px] container mx-auto mt-[32px] mb-[86px]">
      <div className="w-full flex justify-between gap-x-[26px]">
        {categories.map((item: any) => (
          <button key={item._id} className={`btn w-[280px] h-[43px] outline-slate-200 text-black hover:bg-green-500 hover:text-white ${category === item._id  ? "bg-green-500 text-white" : ''}`} onClick={() => {
